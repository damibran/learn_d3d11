...
namespace dmbrn
{
	...
	private:
		...
		struct VertexBufferData
		{
			...
			Vertex data[3] =
			{
				Vertex{DirectX::SimpleMath::Vector4(0, 0.5f, 0.5, 1.0f),DirectX::SimpleMath::Vector4(1, 0, 0, 1.0f)},
				Vertex{DirectX::SimpleMath::Vector4(0.5,-0.5,0.5,1.0f),DirectX::SimpleMath::Vector4(0, 1, 0, 1.0f)},
				Vertex{DirectX::SimpleMath::Vector4(-0.5f, -0.5f,0.5, 1.0f),DirectX::SimpleMath::Vector4(0, 0, 1, 1.0f)}
			};
		}vertexBufferData;
